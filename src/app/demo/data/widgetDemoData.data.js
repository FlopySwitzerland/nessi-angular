...
var today = moment().minutes(0).valueOf();
exports.widget1Data = [
    {
        key: 'Users',
        area: true,
...
exports.discreteBarDemoDataGenerator = function () {
    var temp = [
        {
            key: 'Total Sales',
            values: []
    ...
    exports.discreteBarDemoValues.forEach(function (value, index) {
...
exports.lineChartDemoDataGenerator = function () {
    ...
    exports.lineChartDemoValues.forEach(function (value, index) {
        temp[0].values.unshift({
            "date": today - 1000 * 60 * 60 * 24 * index,
            "value": value
        });
...
exports.lineChartInterpolatedDemoValues = [
    186, 34, 172, 161, 27, 163, 87, 119, 123, 15, 180, 7, 72, 107, 181, 33, 45, 143, 91, 200
];
exports.lineChartInterpolatedDemoDataGenerator = function () {
    var temp = [
        {
            key: 'Total Clicks',
            values: []
    ...
    exports.lineChartInterpolatedDemoValues.forEach(function (value, index) {
        temp[0].values.unshift({
            "date": today - 1000 * 60 * 60 * 24 * index,
            "value": value
        });
...
exports.recentCustomersDemoValues = [
...
exports.recentSalesDemoDataGenerator = function () {
    var temp = [
        {
            key: 'Sales',
            area: true,
    ...
    exports.recentCustomersDemoValues.forEach(function (value, index) {
        temp[0].values.unshift({
...
exports.trafficSourcesDemoData = [
    [
        {
            key: 'Direct',
            area: true,
